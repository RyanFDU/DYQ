...
class Bottleneck(nn.Module):
    """change by pytorch implement:
    the stride of the first 1x1 conv-layer is changed from 2 to 1
    the stride of the second 3x3 conv-layer is changed from 1 to 2
